...
using SD220_Deliverable_1_DGrouette.Providers;
using SD220_Deliverable_1_DGrouette.Results;
...
namespace SD220_Deliverable_1_DGrouette.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public IHttpActionResult ResetPassword(ResetPasswordBindingModel passwordBindingModel)
        {
            ...
            // Filter in the resetPasswordBindingModel takes care of comparing the two passwords for us,
            // It would otherwise be returned in the bad request, so its safe to use the newPassword here.
            var result = UserManager.ResetPassword(user.Id, passwordBindingModel.Token, passwordBindingModel.NewPassword);
